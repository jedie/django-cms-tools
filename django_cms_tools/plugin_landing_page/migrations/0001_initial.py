    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('robots_index', models.BooleanField(default=False, help_text="If checked: meta robots 'index' is set, otherwise 'noindex'.", verbose_name='Robots-Index')),
                ('robots_follow', models.BooleanField(default=False, help_text="If checked: meta robots 'follow' is set, otherwise 'nofollow'.", verbose_name='Robots-Follow')),
